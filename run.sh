...
for method in dpt residual mimo; do
for num in 1 2 3; do
...
# CUDA_VISIBLE_DEVICES=0 python main.py --datasets=${data} --model_name=${model} --enc_prompt_tokens 100 -ts 16 -e 100 --save_name ${model}_${data}_${method} --method ${method}
