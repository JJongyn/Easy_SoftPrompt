...
def process_args():
    ...
    parser.add_argument('--method', type=str, default='dpt', help='method')
    parser.add_argument('--save_dir', type=str, default='/data/jongyoon/jongyoon/nlp/llm/DPT/results/', help='Save path')
    parser.add_argument('--save_name', type=str, default='test', help='Save name')
    parser.add_argument('--memo', type=str, default='-', help='Save name')
